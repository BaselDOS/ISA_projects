...
add $s2, $zero, $imm, Inisialize	# set $s2 as Inisialize
add $a0, $zero, $imm, -1	# $a0 = -1 
add $a1, $zero, $imm, -128	# $a1 = -128 
...
ReadSector:
	...
	add $t0, $zero, $imm, 4		# $t0 = 4
	beq $imm, $a0, $t0, Inisialize	# if $a0 = 4 jump to Inisialize
	add $t0, $zero, $imm, 14	# $t0 = 14
	out $imm, $zero, $t0, 1		# set diskcmd = 1, read from sector
	beq $imm, $zero, $zero, Inisialize	# jump to Inisialize
WriteXOR:
...
For:
	...
	blt $imm, $t1, $t2, Loop	# if $t1 < 128 jump to Loop
